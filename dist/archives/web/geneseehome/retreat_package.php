      ...
      <td class="rightCol_contextinfo" valign="top" align="right"> <!-- begin right col table -->
       ...
       <table cellpadding="0" cellspacing="0" border="0" width="630"> <!-- begin context sensitive table -->
        ...
        <tr>
            ...
            <img src="pics/retreat_package_header.jpg" width="468" height="37" border="0"/>            </td>
        </tr> <!-- end IMAGES TR -->
        ...
        <tr> <!-- begin INFO TR -->
        	<td valign="top" height="316" class="infoTD_text">
              ...
              <p>A stay at Genesee Home includes a bedroom with a private bath, each with its own character for five nights, three meals per day, hostess gift, the use of our Library and all recreation activities on the ranch.</p>

 <p>We want Genesee Home to be affordable to all Pastors or Missionaries and their spouses and therefore we ask only to be reimbursed for approximately 1/3 of our operating expenses. This works out to be only $395 for each couple. This of course is inclusive of five nights stay in a beautiful restored Victorian Home, all meals, use of our extensive library and use of all recreational facilities. From time to time we offer unadvertised special rates. Call us at 530-284-1082 for more information.
Some guests can pay for their retreats personally, while others may need to be funded by their church board, from the church budget, or by a member in their congregation.</p>

 <p>In addition, for those who have inadequate funding available, we offer a partial scholarship for a week at Genesee Home.</p>
