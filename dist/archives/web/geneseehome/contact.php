      ...
      <td class="rightCol_contextinfo" valign="top" align="right"> <!-- begin right col table -->
       ...
       <table cellpadding="0" cellspacing="0" border="0" width="630"> <!-- begin context sensitive table -->
        ...
        <tr>
            ...
            <img src="pics/contact_info_header.jpg" width="468" height="37" border="0"/>            </td>
        </tr> <!-- end IMAGES TR -->
        ...
        <tr> <!-- begin INFO TR -->
        	<td valign="top" height="316" class="infoTD_text">
              ...
              <table class="contactTable" cellpadding="0" cellspacing="0" border="0">
              <tr>  
              <td colspan="2" class="contactHeader">GENESEE HOME</td></tr>
              <tr><td class="tableName">
              Address:</td>
             <td class="contact_infoTD">7202 Genesee Rd, Taylorsville, CA 95983</td></tr>     
            <tr>
            <td class="tableName">
            Phone:</td>
            <td class="contact_infoTD">(530) 284.1082</td></tr>
             
             <tr><td class="tableName">
            Fax:</td>
            <td class="contact_infoTD">(530) 284.1083</td></tr>
            <tr><td class="tableName">
            Email:</td><td class="contact_infoTD">
            ministrydirector[at]geneseehome.org</td></tr>
            </table>
