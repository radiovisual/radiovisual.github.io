      ...
      <td class="rightCol_contextinfo" valign="top" align="right"> <!-- begin right col table -->
       ...
       <table cellpadding="0" cellspacing="0" border="0" width="630"> <!-- begin context sensitive table -->
        ...
        <tr>
            ...
            <img src="pics/scholarships_header.jpg" width="468" height="37" border="0"/>            </td>
        </tr> <!-- end IMAGES TR -->
        ...
        <tr> <!-- begin INFO TR -->
        	<td valign="top" height="316" class="infoTD_text">
              ...
              <p>We believe that Genesee Home's policy of asking to be reimbursed for only approximately one third of our operating expenses will result in Genesee Home offering tremendous value to its guests, moreover at a cost which is reasonably affordable. It is our desire to have all those who want to participate in the Genesee Home experience have that opportunity regardless of their financial position.</p>

<p>Therefore, for individuals who require some financial assistance the Board has established an annual scholarship budget which is used to supplement the cost of visiting Genesee Home.</p>

<p>Thus, we encourage anyone who has a need for assistance to request a scholarship when completing their <a href="request_a_visit.php">Request for a Visit</a>.</p>

<p>If you have already submitted a Request for a Visit and didn't submit a Scholarship Application at that time you may go to our <a href="scholarship_request.php">Scholarship Application</a> at this time. Fill out the form and submit to our Ministry Director, Charley Blom.</p>
            ...
            <!-- BUTTON -->
    		 ...
    		 <a href="scholarship_request.php"><img src="pics/request_scholarship_button.jpg" border="0" /></a> 
               <br />
               <br />
          <a href="request_a_visit.php"><img src="pics/request_a_visit_button.jpg" border="0" /></a> 
