      ...
      <td class="rightCol_contextinfo" valign="top" align="right"> <!-- begin right col table -->
       ...
       <table cellpadding="0" cellspacing="0" border="0" width="630"> <!-- begin context sensitive table -->
        ...
        <tr>
            ...
            <img src="pics/weather_fall_thumb.jpg" width="157" height="139" border="0"/> <br />
            <img src="pics/weather_snow_thumb.jpg" width="157" height="139" border="0"/>                       </td>
            
            <td valign="top" class="header_image"> <!-- begin HEADER IMAGE td -->
            <img src="pics/weather_header.jpg" width="468" height="37" border="0"/>            </td>
        </tr> <!-- end IMAGES TR -->
        ...
        <tr> <!-- begin INFO TR -->
        	<td valign="top" height="316" class="infoTD_text">
               ...
               At Genesee Home, we experience four seasons each year with temperatures in this beautiful valley ranging as shown below: <br /><br />


<b>FALL</b><br/>
Average High: 71&deg; F<br/> 
Average Low: 31&deg; F<br/><br/>

<b>WINTER</b><br/>
Average High: 49&deg; F<br/> 
Average Low: 23&deg; F<br/><br/>

<b>SPRING</b><br/>
Average High: 65&deg; F<br/>
Average Low: 31&deg; F<br/><br/>

<b>SUMMER</b><br/>
Average High: 88&deg; F<br/>
Average Low: 41&deg; F<br/><br/>

<br /><br />
Click button below for a 10-day weather forcast:<br /><br />

<a href="http://www.weather.com/weather/local/USCA1131?lswe=taylorsville&lswa=WeatherLocalUndeclared" target="_blank"/>

<img src="pics/10day_forcast_button.jpg" border="0" /></a>
<br />
<span class="italic_9">- opens new browser window to weather.com<br /> 
- simply close the new window to return</span><br />
