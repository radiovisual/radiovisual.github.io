...
$(document).ready(function(e) {
	...
	var thumbs = imagesLoaded( '#photo_video_right_col');
		
	thumbs.on( 'done', function( instance ) {
  		// images are loaded
	}); // end thumbs are loaded
	...
	// infographic hoverlink behaviors
	$('.infographic_hoverlink').hover(
		function(){
			$(this).find('.ihl_description').fadeIn("slow");	
		}, 
		function(){
			$(this).find('.ihl_description').fadeOut("slow");	
		}
	);
	
	$('.ihl_description').click(function(e){
		e.preventDefault();
		var l = $(this).parent().find('a').prop('href');
