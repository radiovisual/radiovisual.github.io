...
$(document).ready(function(){
    ...
    $('.play_button').hover(function(){
        ...
        $(this).parent().addClass("dark_overlay"); }, function(){ $(this).parent().removeClass('dark_overlay'); });
...
function fixFullWidthImages(){
    $('.img-full-width img').each(function(){
        if( !$(this).hasClass('social-media') && !$(this).hasClass('loading_gif') ){
    ...
    if($(window).width() > imgh){
        imgh = $(window).width();
    }

    bigvideoimg.each(function(){
        if (!$(this).hasClass('index_img')){
            $(this).css("paddingTop", "58px");
        }
